...
Moving from the top left corner of the plot (higher heart rate and lower jump rate) toward the lower right corner (lower heart rate and higher jump rate) shows an increase in jumping efficiency over time (though not necessarily cardio fitness)[^4].
