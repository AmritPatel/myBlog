...
# Does the data show that extreme heat affect running performance?
...
In my next post, I will write a simple function using what I've developed to-date to plot running performance and related metrics for any run or group of runs that is time-based rather than lap-based to serve as a more flexible diagnostic tool. 
