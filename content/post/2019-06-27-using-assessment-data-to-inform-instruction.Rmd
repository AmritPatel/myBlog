...
The `swirl`[^2] package's power comes from its ability allow individual students to teach and/or practice programming and data science *interactively* and *at one's own pace*.

[^2]: For the R programming language -- this is the language that I will teach in my class.
