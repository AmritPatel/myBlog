...
- The spikes in 2020-06-13 heat index correspond to the last part of a lap for this course, which was around a nearby lake. I remember thiis stretch not being in shade like most of the run and uncomfortably hot (as the data supports).

- Function removesl first 1.3 mi of RPI data due to noise.

- Function removes first 0.1 mi of other data due to inaccurate measurements.
...
- Re-analyze .fit data from Pike's Peek 10k PR and compare with value in running economy over time post plot.[^5]
